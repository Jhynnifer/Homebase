...
if ( ! function_exists('b4st_enqueues') ) {
	function b4st_enqueues() {
	  ...
	  wp_register_style('homebase-css', get_template_directory_uri() . '/public/css/app.css', false, null);
		wp_enqueue_style('homebase-css');

		// Scripts

		wp_register_script('font-awesome-config-js', get_template_directory_uri() . '/resources/assets/js/font-awesome-config.js', false, null, null);
	  ...
	  wp_register_script('bootstrap-js', 'https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.0.0/js/bootstrap.min.js', false, '4.0.0', true);
		...
		wp_register_script('homebase-js', get_template_directory_uri() . '/public/js/app.js', false, null, true);
